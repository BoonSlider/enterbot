...
public class Juggernaut(int nameSuffix) : IBot(nameSuffix)
{
    public override string NamePrefix => "juggernaut";
    ...
    public override IList<IOperationResult> PlayTurn(IPlayer p)
    {
        ...
        {
            if (w == Weapon.Bat || w == Weapon.Knife || w == Weapon.Uzi) continue;
